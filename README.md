...
## 💫 About Me:
🔭 Currently working on visual instruction tuning within large multimodal models to improve multimodal AI interactions.<br>

✨ I have worked at Sony for 3 years where I have built
- A large-scale AI chatbot currently used at Sony support sites.<br>
- A decentralized blockchain platform called Mobility as a Service (MaaS) for the Netherlands government.<br>

🔗 Check out [my website](https://ankithbala.com/) to learn more about me.<br>
...
## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/ankithb) 
